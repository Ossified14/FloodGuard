...
<head>
    ...
    <title>Tambah Laporan - Monitoring Banjir</title>
...
<aside class="sidebar">
    ...
    <a href="<?= base_url('dashboard/tambah_laporan') ?>" class="nav-link active">
...
<main class="main-content">
    <div class="header">
        ...
        <p>Silakan isi form di bawah ini untuk melaporkan kondisi sungai terkini.</p>
    </div>

    <div class="form-card">
        <?php if(isset($error)) echo "<div style='color:red; margin-bottom:1rem;'>$error</div>"; ?>
        <!-- Pastikan menggunakan enctype multipart/form-data untuk upload gambar -->
        <form action="<?= base_url('dashboard/simpan_laporan') ?>" method="post" enctype="multipart/form-data">
            
            <div class="form-group">
                <label for="lokasi_sungai">Lokasi Sungai</label>
                <input type="text" name="lokasi_sungai" id="lokasi_sungai" class="form-control" placeholder="Contoh: Sungai Ciliwung, Manggarai" required>
            </div>

            <div class="form-group">
                <label for="tinggi_air">Tinggi Air (cm)</label>
                <input type="number" name="tinggi_air" id="tinggi_air" class="form-control" placeholder="Contoh: 150" required>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea name="deskripsi" id="deskripsi" class="form-control" placeholder="Jelaskan kondisi secara singkat..." required></textarea>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="file-upload-wrapper">
                    ...
                    <p style="color:var(--text-muted); font-weight:500;">Klik atau seret gambar ke sini untuk upload</p>
                    <p style="color:#9CA3AF; font-size:0.875rem; margin-top:0.5rem;">Format didukung: JPG, PNG, GIF</p>
            ...
            <div class="form-actions">
                ...
                <button type="submit" class="btn btn-primary"><i class="fa-solid fa-paper-plane" style="margin-right:0.5rem;"></i> Simpan Laporan</button>
            </div>
